...
| **rocky** | 192.168.5.28 | Ubuntu 26.04 | Dev server (Docker) | Proxmox VM | vTPM, sealed | Replaced tars for all Docker/dev work (2026-08-31). All services migrated. |
...
| **gargantua** | 192.168.5.109 | Ubuntu 26.04 | Workstation | — | TPM, sealed | sudo-rs (no log_output/iolog_dir). Proton suite fully installed. |
...
| Host | Status |
|------|--------|
| tars, case, endurance, ranger, trainerroad, gargantua, rocky | Done (handle `0x81010001`) |
